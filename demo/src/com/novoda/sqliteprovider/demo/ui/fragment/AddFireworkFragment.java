...
public class AddFireworkFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		addButton = (Button) root.findViewById(R.id.add_firework_add_button);
		addButton.setOnClickListener(onAddFireworkClick);
	...
	private boolean fieldsArentFilledIn() {
		return checkForInput(nameEditText) || checkForInput(colorEditText) ||
